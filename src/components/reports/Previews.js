    ...
    res = axios
      ...
      .then((res) => {
        ...
        document.querySelector(".rt1").innerText =
          parseInt(res.data[11][1].trichy) * 0;
        document.querySelector(".rt2").innerText =
          parseInt(res.data[11][1].phuketKrabi) * 53000;
        document.querySelector(".rt3").innerText =
          parseInt(res.data[11][1].mysoreBandipur) * 20000;
        document.querySelector(".rt4").innerText =
          parseInt(res.data[11][1].belurHampi) * 15000;
              ...
              <TableBody>
                {data.map((dat) => (
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField size="small" id={dat} variant="outlined" />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
